...
public class ConsultaDoacoesView implements Serializable {
	...
	public void enviarEmailInteresse() {
		...
		msg.append("\n");
		msg.append("\n");
		msg.append("Ol� " + selectedDoacao.getVoluntarioEntity().getNome());
		msg.append("\n");
		msg.append("\n");
		msg.append("A ONG " + ong.getNomeONG() + " tem interesse na sua doa��o intitulada como "
		...
		String assunto = "[HelpTheNext] Uma ONG est� interessada na sua doa��o!!";
